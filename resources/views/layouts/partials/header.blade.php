      ...
      <ul class="nav navbar-nav">
                          ...
                          <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tabs">
                            ...
                            <div class="media media-sm bg-warning-10 p-4 mb-0">
                              ...
                              <div class="media-body">
                                <a href="user-profile.html">
                                  <span class="title mb-0">{{__("trans.Admin")}}</span>
                                  <span class="discribe">Extremity sweetness difficult behaviour he of. On disposal of as landlord horrible. Afraid at highly months do things on at.</span>
                                  <span class="time">
                                    <time>{{__("trans.Just now")}}</time>...
                                  </span>
                                </a>
                              </div>
                            </div>
                            ...
                            <div class="media media-sm p-4 bg-light mb-0">
                              ...
                              <div class="media-body">
                                <a href="user-profile.html">
                                  <span class="title mb-0">{{__("trans.New event added")}}</span>
                            ...
                            <div class="media media-sm p-4 mb-0">
                              ...
                              <div class="media-body">
                                <a href="user-profile.html">
                                  <span class="title mb-0">{{__("trans.Sagge Hudson")}}</span>
        ...
        <li class="dropdown user-menu">
          <button class="dropdown-toggle nav-link" data-toggle="dropdown">
            <img src="{{ asset('public/theme/images/user/user-default-image.png') }}" class="user-image rounded-circle" alt="User Image" />
            @if (Auth::check())
          ...
          <ul class="dropdown-menu dropdown-menu-right">
            ...
            <!-- <li>
                        <a class="dropdown-link-item" href="email-inbox.html">
                          ...
                          <span class="nav-text">{{__("trans.Message") }}</span>
                      ...
                      <li>
                        <a class="dropdown-link-item" href="user-activities.html">
                          ...
                          <span class="nav-text">{{__("trans.Activitise") }}</span></a>
                      </li> -->
            @auth
            {{-- <form action="{{ route('logout.perform') }}" id="logoutForm" method="post">
              @csrf
